...
export const artworks: Artwork[] = [
  ...
  {
    slug: "edge-of-civilization",
    title: "Edge of Civilization",
    year: "2026",
    medium: "Oil on canvas",
    dimensions: "48 × 60 cm",
    description: "",
    image: "/images/edge-of-civilization.jpg",
    imageWidth: 2000,
    imageHeight: 1600,
    original: { available: false },
    prints: [],
  ...
  },
  {
    ...
    dimensions: "60 × 48 cm",
    description: "",
    image: "/images/end-of-the-world.jpg",
    imageWidth: 2000,
    imageHeight: 1600,
    original: { available: false },
    prints: [],
